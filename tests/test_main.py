...
async def test_handler_returns_response():
    ...
    with (
        patch("analyze_paper_agent.main._initialized", True),
...
async def test_handler_initialization():
    ...
    with (
        patch("analyze_paper_agent.main._initialized", False),
        patch("analyze_paper_agent.main.initialize_all", new_callable=AsyncMock) as _mock_init,
        patch("analyze_paper_agent.main.run_agent", new_callable=AsyncMock, return_value=mock_response),
