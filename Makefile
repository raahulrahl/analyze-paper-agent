...
run: env-check ## Run the agent locally
	@echo "🤖 Starting analyze-paper-agent..."
...
run-dev: ## Run the agent in development mode with auto-reload
	...
	@uv run watchfiles "python -m analyze_paper_agent" analyze_paper_agent/
...
docker-build: ## Build Docker image
	...
	@docker build -f Dockerfile.agent -t analyze-paper-agent:latest .

.PHONY: docker-build-no-cache
docker-build-no-cache: ## Build Docker image without cache
	@echo "🐳 Building Docker image (no cache)..."
	@docker build --no-cache -f Dockerfile.agent -t analyze-paper-agent:latest .

.PHONY: docker-run
docker-run: ## Run Docker container with .env file
	@echo "🐳 Running Docker container..."
	@docker run -d \
		--name analyze-paper-agent \
		-p 3773:3773 \
		--env-file .env \
		--restart unless-stopped \
		analyze-paper-agent:latest
...
docker-clean: docker-rm ## Clean up Docker images and containers
	...
	@docker rmi analyze-paper-agent:latest || true
...
docker-push: ## Push Docker image to Docker Hub
	...
	@docker tag analyze-paper-agent:latest raahulrahl/analyze-paper-agent:latest
	@docker push raahulrahl/analyze-paper-agent:latest
...
status: ## Show agent and Docker status
	...
	@docker ps -a | grep analyze-paper-agent || echo "No containers found"
	@echo "\nDocker Images:"
	@docker images | grep analyze-paper-agent || echo "No images found"
	@echo "\nAgent Health:"
...
help:
	@echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
	@echo "  📚 Analyze Paper Agent - Makefile Commands"
	@echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
